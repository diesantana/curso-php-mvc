        ...
        <div class="col-sm-8 col-10">
            <div class="card p-4">
                ...
                <div class="text-center my-3">
                    ...
                    <a href="<?='?ct=admincontroller&mt=handle_delete_agent&id=' . urlencode(aes_encrypt($agent->id))?>" class="btn btn-secondary px-4"><i class="fa-solid fa-check me-2"></i>Sim</a>
                </div>
